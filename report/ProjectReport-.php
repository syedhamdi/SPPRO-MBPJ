    ...
    <table width="600px" border="0">
        ...
        <tr>
          <td><input type="hidden" id="datatodisplay" name="datatodisplay">
            <input type="submit" value="Eksport ke excel">&nbsp;&nbsp; <input type="Button" value="Printer Friendly" ONCLICK="javascript:window.open('report/PrintReport.php?id=Print1&tajuk=LAPORAN MAKLUMAT PROJEK&kategori=<?=$kategori?>&kawasan=<?=$kawasan?>')">
          </td>
        </tr>
     </table>
    </form>
