...
var SundayColor = "#CEECF5"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#CEECF5"; //Background color of Saturday.
var WeekDayColor = "#CEECF5"; //Background color of weekdays.#81BEF7
var FontColor = "#CEECF5"; //color of font in Calendar day cell.
var TodayColor = "#FFFF33"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#81BEF7"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#000000"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#81BEF7"; //color when mouse move over.
...
var imageFilesPath = "images/imagescal/";
//Configurable parameters end

//use the Month and Weekday in your preferred language.
var MonthName = ["Januari", "Februari", "Mac", "April", "Mei", "Jun", "Julai", "Ogos", "September", "Oktober", "November", "Disember"];
...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img onclick='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='"+imageFilesPath+"cal_close.gif' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
...
function pickIt(evt)
{
	...
	if (domStyle)
	{
		domStyle.zIndex = 9999999999999999999999999999999999999999999;
		return false;
	}
